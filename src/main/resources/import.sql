...
-- Park City
insert into city(id, country, name, state, map) values (22, 'USA', 'Utah', 'Park City', '40.648222, -111.535067')
insert into hotel(id, city_id, name, address, zip) values (28, 22, 'Waldorf Astoria Park City', '2100 Frostwood Dr', '84098')
insert into review(id, hotel_id, idx, check_in_date, rating, trip_type, title, details) values (64, 28, 0, '2017-12-15', 5, 2, '5/5', 'Beautiful place, excellent service, AMAZING food.')
